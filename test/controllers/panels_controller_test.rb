...
class PanelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create panel" do
    assert_difference('Panel.count') do
      post panels_url, params: { panel: { page_id: @panel.page_id, title: @panel.title } }, as: :json
    end
  ...
  test "should update panel" do
    patch panel_url(@panel), params: { panel: { page_id: @panel.page_id, title: @panel.title } }, as: :json
    assert_response 200
  end
